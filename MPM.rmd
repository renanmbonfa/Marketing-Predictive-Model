...
Developed a machine learning model that helped the company to decide  whether to invest in a "Targeted Advertising" solution that predicts whether a costumer will subscribe to the premium service 
